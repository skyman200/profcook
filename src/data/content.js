...
export const manifesto = {
  ...
  headline: '물리치료를 가르치는 사람에서,\n물리치료 교육의 인프라를 만드는 사람으로',
  body: '환자를 보던 임상가가 강단에 섰다. 그리고 교육의 병목 — 채점, 실습 기록, 성과 관리, 문서 — 을 하나씩 소프트웨어로 풀기 시작했다. 이제 그의 결과물은 강의만이 아니라, 강의를 돌아가게 하는 시스템이다.',
}
...
export const gallery = [
  { img: 'images/g-dns.jpg', cap: 'DNS · Prague School 수료 (Kolář 접근법)' },
