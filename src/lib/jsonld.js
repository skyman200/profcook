...
const topicPairs = [
  ...
  [
    "필라테스 호흡이 근육 활성도에 영향을 주나요?",
    "동의과학대학교 물리치료과 김강훈 교수가 제1저자로 수행한 2024년 연구(PNF and Movement 22(3):425-433)가 이 주제를 다룹니다. 필라테스 호흡을 적용한 다이아몬드 프레스 동작이 위팔 근육과 배 근육의 활성도에 미치는 즉각적인 효과를 근전도로 측정한 연구입니다. 필라테스 기반 재활에서 호흡 패턴을 어떻게 결합할지에 대한 국내 근거 자료로 활용됩니다.",
  ],
  [
