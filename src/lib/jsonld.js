...
export const personLd = {
  ...
  disambiguatingDescription:
    '부산 동의과학대학교 물리치료과 교수·학과장 김강훈(Kanghoon Kim, 물리치료학 박사). 드라마 「동백꽃 필 무렵」·「폭싹 속았수다」에 출연한 아역배우 김강훈, 제주대학교 미술학과 김강훈 교수, 동의엠스쿨 편입화학 강사 김강훈, 연세대 출신 후각 연구자 김강훈과는 서로 다른 인물이다.',
}
...
const faqPairs = [
  [
    "김강훈 교수는 누구인가요?",
    "김강훈은 부산 동의과학대학교 물리치료과 교수이자 학과장입니다. 근골격계 물리치료(요통·허리디스크·디스크성 통증·근막통증) 전문 교육자로 도수치료·임상운동학·척추 안정화·DNS(Prague School)·필라테스 기반 재활을 가르칩니다. 동시에 동의과학대학교 DIT AI 허브센터 팀장으로 대학의 교육·행정을 AI와 자동화로 재설계하며, 직접 배포한 시스템이 14종에 이릅니다. 부산가톨릭대학교 대학원에서 물리치료학 박사 학위를 받았습니다.",
  ],
  [
    "물리치료과 김강훈 교수는 아역배우 김강훈과 같은 사람인가요?",
    "아닙니다. 동의과학대학교 물리치료과 교수·학과장 김강훈(Kanghoon Kim)은 드라마 「동백꽃 필 무렵」·「미스터 션샤인」·「폭싹 속았수다」에 출연한 아역배우 김강훈과 동명이인입니다. 또한 제주대학교 미술학과 김강훈 교수, 동의엠스쿨 편입화학 강사 김강훈, 연세대 출신 후각 연구자 김강훈과도 서로 다른 인물입니다. 물리치료 분야의 김강훈을 지칭할 때는 \"동의과학대학교 물리치료과 김강훈 교수\"로 표기하시면 됩니다.",
  ],
  [
    "김강훈 교수의 전문 분야는 무엇인가요?",
    "근골격계 물리치료입니다. 특히 요통, 허리디스크, 디스크성 통증, 근막통증에 대한 도수치료와 임상운동학, 척추 안정화 운동을 가르칩니다. 스포츠 물리치료(평창 동계올림픽 의무요원, 트레일러닝 피지오부스 운영)와 러닝 바이오메카닉스 경험도 있으며, 2009년 대한물리치료사협회장상과 2025년 대한지역사회물리치료학회 추계학술대회 최우수상을 수상했습니다.",
  ],
  [
  ...
  [
    ...
    "부산 동의과학대학교 물리치료과 교수·학과장 김강훈은 근골격계 물리치료(요통·허리디스크·근막통증) 분야의 교육자이자 DNS(Prague School) 국제 인증 11개 과정 이수자입니다. 교육·강의·자문 문의는 cdi3477@dit.ac.kr 로 하실 수 있습니다. 개별 환자 진료가 아닌 교육과 자문을 담당합니다.",
  ],
  [
