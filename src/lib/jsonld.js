  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '김강훈은 부산 동의과학대학교 물리치료과 교수이자 학과장입니다. 근골격계 물리치료(요통·허리디스크·근막통증) 전문 교육자이며, DNS(Prague School)·도수치료·임상운동학·필라테스 기반 재활을 가르칩니다. 동시에 교육 현장의 문제를 AI·자동화로 푸는 바이브코딩 개발자로, 실제 배포한 시스템이 12종에 이릅니다.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '김강훈 교수는 물리치료 교육 현장에서 채점·실습기록·성과관리·문서 자동화를 위해 웹앱 7종과 자동화 파이프라인 5건 등 시스템 12종을 직접 배포한 바이브코딩 실진가입니다. 한국전문대교육협의회(KCCE), 동의과학대 교수학습개발센터 등에서 AI·교육혁신을 주제로 초청 강연을 했습니다.',
      },
    },
  ],
}
